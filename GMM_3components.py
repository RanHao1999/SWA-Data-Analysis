...
def all_process(idx_time, Protons_initial, Alphas_initial, vdf_cdffile, grnd_cdffile, mag_cdffile, one_particle_noise_level, result_path):
    ...
    print("Before removing one-particel noise: ", np.count_nonzero(vdf_corrected))
    ...
    # Full 
    plot_one(ax[0, 0], ax[1, 0], vel, vdf_2ndcorrected, f_core_full, f_beam_full, f_alpha_full, 'Full')
    # diag
    plot_one(ax[0, 1], ax[1, 1], vel, vdf_2ndcorrected, f_core_diag, f_beam_diag, f_alpha_diag, 'Diag')
    # tied
    plot_one(ax[0, 2], ax[1, 2], vel, vdf_2ndcorrected, f_core_tied, f_beam_tied, f_alpha_tied, 'Tied')
    # spherical
    plot_one(ax[0, 3], ax[1, 3], vel, vdf_2ndcorrected, f_core_spherical, f_beam_spherical, f_alpha_spherical, 'Spherical')
